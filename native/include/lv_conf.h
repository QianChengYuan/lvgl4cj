...
/* clang-format off */
#if 1 /*Set it to "1" to enable content - managed by lvgl4cj*/
...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    #define LV_MEM_SIZE (512 * 1024U)         /*[bytes] lvgl4cj: 512KB*/
...
#if LV_USE_FS_POSIX
    #define LV_FS_POSIX_LETTER 'A'     /*lvgl4cj: 盘符固定为 A，路径形如 A:/xxx*/
